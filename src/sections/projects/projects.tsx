...
const projects = [
  {
    ...
    githubLink: "",
    description:
      "Leveraging the power of TypeScript, JavaScript, and modern frameworks to build robust web applications.",
  },
  {
    id: 2,
    icon: tattooImage1.src,
    ...
    githubLink: "",
    description:
      "Creating dynamic, responsive user interfaces with React and Next.js.",
  },
  {
    id: 3,
    icon: tattooImage1.src,
    ...
    githubLink: "",
    description:
      "Designing and implementing efficient RESTful and GraphQL APIs with Node.js.",
  },
  {
    id: 4,
    icon: tattooImage1.src,
    ...
    githubLink: "",
    description:
      "Utilizing AWS services and PostgreSQL to develop scalable, data-driven solutions.",
  },
];
